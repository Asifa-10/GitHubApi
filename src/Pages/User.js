...
const User=()=>{
  ...
  return(
    <>
      <section className="bg-slate-900 -mb-10 -my-10">
        <div className="container mx-10 my-10 ">
          <a href="/">
            <button class="flex text-black bg-slate-400 border-0 py-2 px-5 mx-10 mt-10 focus:outline-none hover:bg-indigo-600 rounded text-lg">Home</button>
          </a>

          <div className="">
            <div className="flex justify-center ml-28 " >   
                <img className="flex rounded-lg justify-center my-12 -mx-44 inline-flex mt-24" src={data.avatar_url} alt="" width={100} height={100}/>
                <h1 className="text-2xl ml-20 text-white font-bold inline-flex mt-10">{data.login}</h1>
            </div>
          ...
          <div className="flex flex-wrap sm:-m-4 -mx-4  md:space-y-0 space-y-6">
            <div className="p-4 md:w-1/4 flex flex-col text-center items-center my-10">
              ...
              <div class="flex-grow ">
                <h2 class="text-white text-lg title-font font-medium ">Repos</h2>
